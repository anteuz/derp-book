...
export const REMOVE_RECIPE_FROM_UNSORTED_SLOT = 'REMOVE_RECIPE_FROM_UNSORTED_SLOT';
...
export class RemoveRecipeFromUnsortedSlot implements Action {
  readonly type = REMOVE_RECIPE_FROM_UNSORTED_SLOT
  constructor(public payload: Recipe) {}
}
...
export type WeeklyMenuActions = AddRecipeToUnSortedSlot | AddRecipeToMenuSlot | RemoveRecipeFromMenuSlot | RemoveRecipeFromUnsortedSlot;
